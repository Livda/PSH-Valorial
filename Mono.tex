...
Les grandes entreprises s’intéressent également à l’innovation pour améliorer leur organisation, leurs processus de production et leurs stratégies de marketing.
	...
	\section{L'exemple du pôle Valorial}
		...
		Afin d'illustrer les propos que nous avons tenus précédemment, il est important de prendre un exemple concret. Le pôle de compétitivité Valorial est une structure qui aide les entreprises de l'agro-alimentaire à innover. Pour comprendre son fonctionnement, voyons pour commencer ce qu'est Valorial, pour voir ce qu'elle prévoit à l'avenir, et en quoi elle permet de connaître l'état de santé de l'innovation.
