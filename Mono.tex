...
\chapter{La situation agro-alimentaire bretonne}
	...
	\section{L’agro-alimentaire français dans le marché international}
		...
		\subsection{L'export et la technologie de pointe, des activités porteuses}
			...
			européenne (à hauteur de 18 \% hors subventions)". %http://www.entreprises.gouv.fr/files/files/directions_services/politique-et-enjeux/innovation/tc2015/technologies-cles-2015-sante.pdf
			On constate un effort de la part des entreprises dans l'agro-alimentaire afin d'informer le consommateur de la provenance de ses aliments. En France, cet effort devait être fait par les entreprises depuis 1999 alors que l'Europe l'a adopté seulement en 2002 via  le règlement CEE TRACABILITE 178/2002.
			%http://fr.wikipedia.org/wiki/Tra%C3%A7abilit%C3%A9_agroalimentaire
