...
\chapter{... mais qui ne réussit pas toujours}
	...
	\section{Les solutions actuelles}
		...
		\subsection{Les avancées en matière de recherche}
			\begin{itemize}
				\item De meilleurs outils de recherche ont été trouvés
				\item INRA
				\item Problème d’aujourd’hui => Plus d’importance => Plus de recherches => Plus de résultats
			\end{itemize}
